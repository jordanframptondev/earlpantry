...
export default function Home() {
    return (
        <div className={"flex flex-col h-dvh w-full md:justify-center items-center text-[#FFFD00] font-bb-modern relative pt-[33vh] md:pt-0"}>
            ...
            <div className={"coming-soon-content flex flex-col md:flex-row transition-all duration-1000 ease-in-out"}>
